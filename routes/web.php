...
use App\Http\Controllers\Client\InvoiceReturnController;
...
Route::post('/invoices/add-shop', [InvoiceController::class, 'addShop'])->name('invoices.add_shop');
Route::resource('invoice-returns', InvoiceReturnController::class)->only(['create', 'store']);
Route::post('/invoice-returns/add-shop', [InvoiceReturnController::class, 'addShop'])->name('invoice-returns.add_shop');
...
Route::middleware(['auth', 'role:admin,manager'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('orders/toggle-order-item-mark', [AdminOrderController::class, 'toggleOrderItemMark'])->name('orders.toggle_order_item_mark');
